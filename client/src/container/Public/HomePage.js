...
import { ListPost, Pagination, Province, ReleasePost, Sidebar, SidebarItem } from '../../components/Public/index'
    ...
    return (
        <div className='w-full flex flex-col gap-10'>
            ...
            <div className='w-full flex phone:flex-col tablet:flex-col gap-5 '>
                ...
                <div className='pc:w-[70%] laptop:w-[70%] flex flex-col gap-5  mb-[50px] phone:w-full tablet:w-full'>
                    <ListPost />
                    <Pagination
                        count={count}
                        data={posts}
                ...
                <div className='w-[30%] flex flex-col justify-start phone:hidden tablet:hidden'>
                    <Sidebar />
                </div>
            </div>
        </div>
