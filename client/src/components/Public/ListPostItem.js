...
const ListPostItem = ({ images, price, acreage, description, id, address, user, title, createdAt, order, isLoading }) => {
        ...
        <>
            {
                isLoading ? (
                    ...
                    phone:gap-3 phone:flex-col phone:shadow-sm tablet:gap-3 tablet:flex-col tablet:shadow-sm w-full flex items-center px-5 py-[15px]'
                            key={index}
                        >
                            <Skeleton className='pc:w-[240px] pc:h-[240px] pc:flex-none laptop:w-[240px] laptop:h-[240px] laptop:flex-none relative cursor-pointer rounded-[10px] phone:w-full phone:h-[300px] tablet:w-full tablet:h-[300px]' />
                            <div className='pc:flex-auto pc:h-[240px] pc:ml-4 pc:max-w-[calc(100%-256px)] w-full laptop:flex-auto laptop:h-[240px] laptop:max-w-[calc(100%-256px)] laptop:ml-4 flex flex-col pc:justify-between laptop:justify-between phone:gap-4 phone:w-full tablet:gap-4 tablet:w-full items-start'
                            >
                                ...
                                <div className='w-full pc:flex pc:items-center pc:justify-between laptop:flex laptop:items-center laptop:justify-between gap-4'>
                                    <div className='flex pc:gap-4 pc:items-center pc:w-[80%] laptop:items-center laptop:gap-4 laptop:w-[80%] justify-between phone:flex-col phone:items-start phone:gap-2 tablet:flex-col tablet:items-start tablet:gap-2'>
                                        <div className='flex h-8 gap-4 items-center w-1/2'>
                                            <Skeleton className='h-full w-full rounded-[5px]' />
                                            <Skeleton className='h-full w-12 rounded-[5px]' />
                                        </div>
                                        <Skeleton className='h-8 pc:w-[45%] laptop:w-[45%] phone:w-full rounded-[5px]' />
                                    </div>
                                    <Skeleton className='h-8 w-[20%] phone:hidden tablet:hidden rounded-[5px]' />
                                </div>
                                <Skeleton className='h-[54px] w-full phone:hidden tablet:hidden rounded-[5px]' />
                                <div className='w-full flex items-center pc:justify-between laptop:justify-between gap-4 h-8'>
                                    <Skeleton className='h-full pc:w-[30%] laptop:w-[30%] phone:w-[35%] tablet:w-[35%] rounded-[5px]' />
                                    <Skeleton className='h-full pc:w-[30%] laptop:w-[30%] phone:w-[35%] tablet:w-[35%] rounded-[5px]' />
                                    <Skeleton className='h-full w-[30%] phone:hidden tablet:hidden rounded-[5px]' />
                                </div>
                                <div className='pc:hidden laptop:hidden w-full h-8'>
                                    <Skeleton className='h-full w-full rounded-[5px]' />
                                </div>
                            </div>
                        </div >
                    ...
                    <div className={` ${order === 3
                        ...
                        : order === 2
                            ? `pc:border-t pc:border-t-[#ea2e9d] laptop:border-t laptop:border-t-[#ea2e9d]
                        phone:flex-col phone:gap-3 phone:bg-white phone:shadow-sm  tablet:flex-col tablet:gap-3 tablet:bg-white tablet:shadow-sm`
                            : `pc:border-t pc:border-t-[#3763e0] laptop:border-t laptop:border-t-[#3763e0]
                        ...
                        <div
                            className={`${order === 3
                                ? `pc:w-[240px] pc:h-[240px] pc:flex-none laptop:w-[240px] laptop:h-[240px] laptop:flex-none relative cursor-pointer rounded-[10px] phone:w-full phone:h-[300px] tablet:w-full tablet:h-[300px]`
